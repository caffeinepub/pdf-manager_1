...
import type { ExternalBlob as _ExternalBlob, PdfEntry as _PdfEntry, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getLatestPdfs(arg0: bigint): Promise<Array<PdfEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLatestPdfs(arg0);
                return from_candid_vec_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPdf(arg0: string): Promise<PdfEntry> {
        if (this.processError) {
            try {
                ...
                return from_candid_PdfEntry_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async searchPdfs(arg0: string): Promise<Array<PdfEntry>> {
        if (this.processError) {
            try {
    ...
    async uploadPdf(arg0: string, arg1: string, arg2: bigint, arg3: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadPdf(arg0, arg1, arg2, await to_candid_ExternalBlob_n17(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_PdfEntry_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PdfEntry): Promise<PdfEntry> {
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PdfEntry>): Promise<Array<PdfEntry>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PdfEntry_n11(_uploadFile, _downloadFile, x)));
}
